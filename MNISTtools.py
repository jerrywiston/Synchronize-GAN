...
fmnist_path = "http://fashion-mnist.s3-website.eu-central-1.amazonaws.com/"
...
def downloadMNIST(path = ".", unzip=True, fashion=False):
    ...
    for i in range(len(zip_list)):
        ...
        if not os.path.exists(fname1):
            if fashion:
                urllib.request.urlretrieve( fmnist_path + zip_name, fname1)
            else:
